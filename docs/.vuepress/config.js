...
module.exports = {
  ...
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ...
    ['meta', { name: 'keywords', content: 'HKUST,香港科技大学,MSSS,内地生' }],
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: '科大攻略', link: '/pages/d05bfa/', items: [
          { text: '全攻略', link: '/pages/d05bfa/' },
          { text: '微信群', link: '/pages/501948/' },
        ]
      },
      {
      ...
      {
        text: '关于我们', link: '/pages/912720/', items: [
          { text: '新生必读', link: '/pages/912720/' },
          { text: '联谊会章程', link: '/pages/1fd97b/' },
          { text: '历任主席', link: '/pages/5ccf6b/' },
          { text: '历任执委会', link: '/pages/6a79ff/' },
          { text: '联络我们', link: '/pages/01f232/' },
        ]
      },
      { text: '清水湾论坛', link: 'https://msss.hkust.edu.hk/forum/' },
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: '© MSSS 31th Exco (2023-24 session)', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
